# Contributing to ScoreGate Contract

Thanks for your interest in improving the ScoreGate on-chain risk score registry.
...
4. Make a small change (e.g., fix a typo or add a doc example):
   - Edit files inside `contracts/scoregate-score/`
...
3. Make your changes inside `contracts/scoregate-score/`.
