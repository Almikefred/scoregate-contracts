# `scoregate-score` module ownership boundaries
...
`scoregate-score` exposes one large contract implementation in
`contracts/scoregate-score/src/lib.rs`, with supporting modules providing
