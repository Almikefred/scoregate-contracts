...
This document defines the compatibility guarantees for each event topic emitted by the ScoreGate Scoring Contract.
...
2. **Subscribe to upgrades** at https://github.com/Ledger-Lenz/scoregate-contract/releases
