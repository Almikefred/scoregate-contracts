...

{
  ...
  echo "Repository: Ledger-Lenz/scoregate-contract"
...
run_step "wasm-release-build" "Locked release WASM builds" cargo build --target wasm32-unknown-unknown --release -p scoregate-score --locked
