...
use crate::{
    types::ModelVersionStatus, ScoreGateScoreContract, ScoreGateScoreContractClient,
    ScoreSubmission,
};
...
fn activate_version(env: &Env, client: &ScoreGateScoreContractClient, version: u32) {
