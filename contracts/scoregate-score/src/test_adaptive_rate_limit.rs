...
use crate::{
    constants::DEFAULT_COOLDOWN_SECS, AdaptiveRateLimit, Error, ScoreGateScoreContract,
    ScoreGateScoreContractClient,
};
...
fn submit(env: &Env, client: &ScoreGateScoreContractClient, wallet: &Address, pair: &soroban_sdk::Symbol, score: u32) -> Result<(), crate::Error> {
