...
use crate::{constants::CONTRACT_VERSION, ScoreGateScoreContract, ScoreGateScoreContractClient};
...
fn test_get_version_consistent_across_instances() {
    ...
    env1.mock_all_auths();
    let contract_id1 = env1.register_contract(None, ScoreGateScoreContract);
    let client1 = ScoreGateScoreContractClient::new(&env1, &contract_id1);

    let env2 = Env::default();
    env2.mock_all_auths();
    let contract_id2 = env2.register_contract(None, ScoreGateScoreContract);
    let client2 = ScoreGateScoreContractClient::new(&env2, &contract_id2);
