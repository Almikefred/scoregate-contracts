//! Interface stability suite for the `IScoreGateScore` composability surface.
//!
...
use crate::{
    constants::CONTRACT_VERSION, Error, ScoreGateScoreContract, ScoreGateScoreContractClient,
    RiskScore,
};
