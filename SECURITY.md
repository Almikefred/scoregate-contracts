...
This policy covers the **`scoregate-score` Soroban smart contract** and the surrounding deployment tooling in this repository.
...
Report security issues by emailing **security@scoregate.io** with the subject line:
